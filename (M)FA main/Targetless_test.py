...
def main(args):
    ...
    print(args.attack_func+' Test Set OA:',(1-OA_adv)*100)
...
#    parser.add_argument('--root_dir', type=str, default='/code/Data/', help='dataset path.')
    ...
    parser.add_argument('--surrogate_model', type=str, default='alexnet', help='alexnet,resnet18,densenet121,regnet_x_400mf')
    parser.add_argument('--target_model', type=str, default='regnet_x_400mf',
    ...
    parser.add_argument('--attack_func', type=str, default='mixup', help='mixup,mixcut,mixwhite,mixblack,mixnoise,mixcutup,'
                                                                             'mixred,mixgreen,mixblue,'
                                                                             'mixaug,mixmosaic,mixcutout,mixforest')
